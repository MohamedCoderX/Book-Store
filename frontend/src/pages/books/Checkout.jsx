...
import { useAddOrderMutation } from '../../redux/features/order';
...
const Checkout = () => {
    ...
    const totalamount = items.reduce((total,i)=>total + i.newPrice * i.quantity,0);
 ...
 const onSubmit = async(data) => {
    ...
    const newOrder = {
      ...
      dispathc(setOrders(newOrder));
    await addorder(newOrder);
    
toast.success("Order Placed Succesfully",{position:"top-left"})
                            ...
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div className="md:col-span-5">
                                    ...
                                    <input
                                        ...
                                        type="text" name="email" {...register("email",{required:true})} id="email" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" 
                                ...
                                <div className="md:col-span-5">
                                    ...
                                    <input
                                        ...
                                        type="number" name="phone" {...register("phone",{required:true})} id="phone" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="+123 456 7890" />
                                </div>
                                ...
                                <div className="md:col-span-3">
                                    ...
                                    <input
                                        ...
                                        type="text" name="address" {...register("address",{required:true})} id="address" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="" />
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        type="text" name="city" {...register("city",{required:true})} id="city" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="" />
                                </div>
